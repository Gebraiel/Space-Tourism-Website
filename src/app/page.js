...
export default function Home() {
  return (
    <>
        <div className="px-6 py-32 h-full m-auto flex gap-20 lg:flex-row flex-col lg:justify-between justify-center  text-center lg:text-left lg:items-end md:items-center flex-wrap">
          ...
          <Link href="/"className="md:w-68 md:h-68 w-36 h-36 rounded-full bg-white flex justify-center items-center text-4 font-bellefair uppercase cursor-pointer hover:ring-[80px] duration-300 ring-white/10">Explore</Link>
        </div>
